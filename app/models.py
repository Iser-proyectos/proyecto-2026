...
Se divide en tres pilares:
  ...
  3. Catálogo de Modelos ML: Modelos ONNX, metadatos técnicos y telemetría.
...
class ModeloML(models.Model):
    ...
    archivo_modelo = models.FileField(
        ...
        verbose_name='Archivo del Modelo (.onnx)',
        help_text='Sube el archivo de tu modelo entrenado (formato aceptado: .onnx)'
    )
